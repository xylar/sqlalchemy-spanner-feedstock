...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sqlalchemy-spanner-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13683&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sqlalchemy-spanner-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sqlalchemy-spanner` can be installed with:

```
conda install sqlalchemy-spanner
```

It is possible to list all of the versions of `sqlalchemy-spanner` available on your platform with:
